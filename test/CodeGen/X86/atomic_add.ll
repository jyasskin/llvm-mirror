...
; CHECK-NEXT: subl
; CHECK-NOT: fence
	%0 = atomicrmw sub i32* %p, i32 %v seq_cst		; <i32> [#uses=0]
	ret void
}
...
; CHECK-NEXT: incq
; CHECK-NOT: fence
	%0 = atomicrmw add i64* %p, i64 1 seq_cst		; <i64> [#uses=0]
	ret void
}
...
; CHECK: add8:
; CHECK: addq $2
	%0 = atomicrmw add i64* %p, i64 2 seq_cst		; <i64> [#uses=0]
	ret void
}
...
; CHECK: addq
	...
	%1 = atomicrmw add i64* %p, i64 %0 seq_cst		; <i64> [#uses=0]
	ret void
}
...
; CHECK: inc3:
; CHECK: incb
	%0 = atomicrmw add i8* %p, i8 1 seq_cst		; <i8> [#uses=0]
	ret void
}
...
; CHECK: add7:
; CHECK: addb $2
	%0 = atomicrmw add i8* %p, i8 2 seq_cst		; <i8> [#uses=0]
	ret void
}
...
; CHECK: addb
	...
	%1 = atomicrmw add i8* %p, i8 %0 seq_cst		; <i8> [#uses=0]
	ret void
}
...
; CHECK: inc2:
; CHECK: incw
	%0 = atomicrmw add i16* %p, i16 1 seq_cst		; <i16> [#uses=0]
	ret void
}
...
; CHECK: add6:
; CHECK: addw $2
	%0 = atomicrmw add i16* %p, i16 2 seq_cst		; <i16> [#uses=0]
	ret void
}
...
; CHECK: addw
	...
	%1 = atomicrmw add i16* %p, i16 %0 seq_cst		; <i16> [#uses=0]
	ret void
}
...
; CHECK: inc1:
; CHECK: incl
	%0 = atomicrmw add i32* %p, i32 1 seq_cst		; <i32> [#uses=0]
	ret void
}
...
; CHECK: add5:
; CHECK: addl $2
	%0 = atomicrmw add i32* %p, i32 2 seq_cst		; <i32> [#uses=0]
	ret void
}
...
; CHECK: add1:
; CHECK: addl
	%0 = atomicrmw add i32* %p, i32 %v seq_cst		; <i32> [#uses=0]
	ret void
}
...
; CHECK: dec4:
; CHECK: decq
	%0 = atomicrmw sub i64* %p, i64 1 seq_cst		; <i64> [#uses=0]
	ret void
}
...
; CHECK: sub8:
; CHECK: subq $2
	%0 = atomicrmw sub i64* %p, i64 2 seq_cst		; <i64> [#uses=0]
	ret void
}
...
; CHECK: subq
	%0 = sext i32 %v to i64		; <i64> [#uses=1]
	%1 = atomicrmw sub i64* %p, i64 %0 seq_cst		; <i64> [#uses=0]
	ret void
}
...
; CHECK: dec3:
; CHECK: decb
	%0 = atomicrmw sub i8* %p, i8 1 seq_cst		; <i8> [#uses=0]
	ret void
}
...
; CHECK: sub7:
; CHECK: subb $2
	%0 = atomicrmw sub i8* %p, i8 2 seq_cst		; <i8> [#uses=0]
	ret void
}
...
; CHECK: subb
	%0 = trunc i32 %v to i8		; <i8> [#uses=1]
	%1 = atomicrmw sub i8* %p, i8 %0 seq_cst		; <i8> [#uses=0]
	ret void
}
...
; CHECK: dec2:
; CHECK: decw
	%0 = atomicrmw sub i16* %p, i16 1 seq_cst		; <i16> [#uses=0]
	ret void
}
...
; CHECK: sub6:
; CHECK: subw $2
	%0 = atomicrmw sub i16* %p, i16 2 seq_cst		; <i16> [#uses=0]
	ret void
}
...
; CHECK: negl
	%0 = trunc i32 %v to i16		; <i16> [#uses=1]
	%1 = atomicrmw sub i16* %p, i16 %0 seq_cst		; <i16> [#uses=0]
	ret void
}
...
; CHECK: dec1:
; CHECK: decl
	%0 = atomicrmw sub i32* %p, i32 1 seq_cst		; <i32> [#uses=0]
	ret void
}
...
; CHECK: sub5:
; CHECK: subl $2
	%0 = atomicrmw sub i32* %p, i32 2 seq_cst		; <i32> [#uses=0]
	ret void
}
